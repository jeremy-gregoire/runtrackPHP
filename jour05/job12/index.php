...
$sql = "select salle.nom as nom_salle, etage.nom as nom_etage, capacite, numero, superficie from salle inner join etage on salle.id_etage = etage.id order by salle.id asc;";
...
<head>
  ...
  <title>RuntrackPHP - Jour05 - Job12</title>
